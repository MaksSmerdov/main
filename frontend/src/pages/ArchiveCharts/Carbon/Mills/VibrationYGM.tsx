...
import {millYGMParams} from "./configMills.ts";
import DailyChart from "../../../../components/Charts/DaliyChart.tsx";

const VibrationYGM: React.FC = () => {

  const datasets: Dataset[] =
    millYGMParams.map(({keyPrefix, label}) => ({
      apiUrl: `api/mill10b`,
      dataKey: 'data',
  ...
  return (
    <DailyChart
      title={`Мельница YGM-9517: Вибрация`}
      stepSize={2}
      yMin={0}
      yMax={30}
      datasets={datasets}
